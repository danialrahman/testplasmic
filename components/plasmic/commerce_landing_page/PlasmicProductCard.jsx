...
import Price from "../../Price"; // plasmic-import: UUdw-zp8TvWQc/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_commerce_landing_page.module.css"; // plasmic-import: ajSivLPSEyA3aicjrEqcMM/projectcss
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: AT6zfNYiNNKwmb/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__cfcQb, {
              [sty.freeBoxsmall__cfcQBhx11E]: hasVariant(
                variants,
                "small",
                "small"
              )
        ...
        {(hasVariant(variants, "small", "small") ? true : true) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__uJXo4, {
              [sty.freeBoxsmall__uJXo4Hx11E]: hasVariant(
                variants,
                "small",
                "small"
              )
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__x04Kd)}>
              {p.renderPlasmicSlot({
                defaultContents: (
              ...
              {p.renderPlasmicSlot({
                defaultContents: (
                  <Rating
                    className={classNames("__wab_instance", sty.rating__bxVxO)}
                  />
                ),
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__pdnrB)}
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
