...
import sty from "./PlasmicValue.module.css"; // plasmic-import: 5wT6ASM6pVKBV/css
import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: G3NvM4PKn1RWwy/icon
...
function PlasmicValue__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__bD9KW, {
          [sty.freeBoxcenter__bD9KWb5Pq4]: hasVariant(
            variants,
            "center",
            "center"
          ),

          [sty.freeBoxtopBottom__bD9KW3MTwv]: hasVariant(
            variants,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__fVfkD)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__r6LiR)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bcbwp, {
          [sty.freeBoxcenter__bcbwpb5Pq4]: hasVariant(
            variants,
            "center",
            "center"
          ),

          [sty.freeBoxwithButton__bcbwpKUp0]: hasVariant(
            variants,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant(variants, "withButton", "withButton") ? true : false) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___6Txv8, {
            [sty.freeBoxcenter___6Txv8B5Pq4]: hasVariant(
              variants,
              "center",
              "center"
            ),

            [sty.freeBoxwithButton___6Txv8KUp0]: hasVariant(
              variants,
              "withButton",
              "withButton"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__wwyKe, {
                  [sty.buttonwithButton__wwyKeKUp0]: hasVariant(
                    variants,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__lzvh9)}
                    role={"img"}
                  />
                }
                rounded={true}
