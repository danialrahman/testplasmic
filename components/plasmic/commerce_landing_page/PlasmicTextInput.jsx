...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: G_Ak2YrPD5H3-/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: C1wQAHxb-bhimv/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 96lYmFzyEzJ47l/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__bL7YN)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4UeSh)}
                role={"img"}
              />
            ),
